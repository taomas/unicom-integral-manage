                ...
                <div class="form-content" :style="{transform: translateX}">
                    <div class="form-wrap">
                        <el-form :model="loginUser" :rules="rules" label-width="0px" class="demo-ruleForm">
                            <el-form-item prop="username">
                                <el-input v-model="loginUser.username" placeholder="username"></el-input>
                            </el-form-item>
                            <el-form-item prop="password">
                                <el-input type="password" placeholder="password" v-model="loginUser.password"></el-input>
                            </el-form-item>
                            <div class="login-btn">
                    ...
                    <div class="form-wrap">
                        <el-form :model="registerUser" :rules="rules" label-width="0px" class="demo-ruleForm">
                            ...
                            <el-form-item prop="password">
                                <el-input type="password" placeholder="password" v-model="registerUser.password"></el-input>
                            </el-form-item>
                            <div class="login-btn">
